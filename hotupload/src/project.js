...
i ? this.DangKyOTP.statusOTP(!!i.phone) : this.DangKyOTP.statusOTP(!1);
}
}
});
cc._RF.pop();
...
console.log("============");
console.log("socket disconnect", JSON.stringify(t));
cc.RedT.reconnect();
},
...
console.log("============");
console.log("socket error", JSON.stringify(t));
},
reconnect: function() {
...
this.cuoc < 100 ? this.addNotice("Vui lòng chọn mức cược...") : cc.RedT.send({
g: {
baucua: {
cuoc: {
cuoc: this.cuoc,
...
spin: function(t) {
this.node.stopAllActions();
var e = cc.moveTo(1, cc.v2(this.node.x, -(this.node.height - 260))).easing(cc.easeInOut(2)), i = cc.callFunc(function() {
this.node.y = 0;
this.RedT.random();
...
spin: function() {
this.node.stopAllActions();
var t = cc.moveTo(1, cc.v2(0, -(this.node.height - 161))).easing(cc.easeInOut(3)), e = cc.callFunc(function() {
...
this.actionOn && this.nut.node.runAction(this.actionOn);
} else {
this.nut.node.stopAllActions();
this.actionOff && this.nut.node.runAction(this.actionOff);
}
}
});
cc._RF.pop();
...
console.log("vao?????????????", 18);
var t = null;
o.isEmpty(this.nickname.string) || o.isEmpty(this.renickname.string) || o.isEmpty(this.red.string) ? t = "Kiểm tra lại các thông tin..." : o.isEmpty(this.nickname.string) || o.isEmpty(this.renickname.string) ? t = "Tên nhân vật không được bỏ trống" : this.nickname.string != this.renickname.string ? t = "Tên nhân vật không khớp.!!" : o.getOnlyNumberInString(this.red.string) < 1e4 ? t = "Số tiền chuyển tối thiểu là 10.000 KUN." : o.isEmpty(this.otp.string) && (t = "Vui lòng nhập mã OTP.");
...
this.rednhan.string = o.numberWithCommas(Math.floor(i - 2 * i / 100));
}
},
onClickOTP: function() {
cc.RedT.send({
...
clear: function() {
var t = JSON.parse(cc.sys.localStorage.getItem("infoRed8"));
t ? t.phone && this.resetLabelAll() : this.resetLabelAll();
},
...
var n = t("SignIn"), o = t("SignUp"), c = t("ForGotPass"), s = t("SignName"), a = t("Shop"), h = t("Profile"), r = t("Settings"), d = t("TheCao"), u = t("GiftCode"), l = t("DEvent"), p = t("PokerNap"), g = t("iMessage");
cc.Class({
extends: cc.Component,
properties: {
signIn: n,
...
if (t.name == e) {
t.children[0].active = !0;
t.children[1].color = cc.Color.BLACK;
} else {
t.children[0].active = !1;
...
var n = t("TaiXiuLichSuPhien"), o = t("TaiXiuLichSu"), c = t("MiniPoker_LichSu"), s = t("MiniPoker_Top"), a = t("BigBabol_LichSu"), h = t("BigBabol_Top"), r = t("BauCua_LichSu"), d = t("BauCua_top"), u = t("Mini3Cay_history"), l = t("Mini3Cay_top"), p = t("CaoThap_history"), g = t("CaoThap_top"), m = t("AngryBird_history"), f = t("AngryBird_top"), v = t("dialogHuongDan"), T = t("MegaJ_history"), b = t("MegaJ_top");
cc.Class({
extends: cc.Component,
properties: {
TaiXiuLichSuPhien: n,
...
var n = t("TaiXiu"), o = t("MiniPoker"), c = t("BigBabol"), s = t("BauCua"), a = t("Mini3Cay"), h = t("CaoThap"), r = t("AngryBirds"), d = t("popupTopHu"), u = t("MiniDialog"), l = t("MegaJackpot");
cc.Class({
extends: cc.Component,
properties: {
minigame: {
...
return t.keyCode === cc.macro.KEY.tab ? (e.isTop() && e.changeNextFocusEditBox(), 
t.preventDefault && t.preventDefault(), !1) : t.keyCode === cc.macro.KEY.enter ? (n.focusGame(), 
e.onNapClick(), t.preventDefault && t.preventDefault(), !1) : void 0;
};
Promise.all(this.header.children.map(function(t) {
return t.getComponent("itemContentMenu");
})).then(function(e) {
...
u.getComponent("NapRed_itemTT").init(r, d);
...
var n = t("Helper"), o = t("Notice"), c = t("Poker_Player"), s = t("Poker_dialog");
cc.Class({
extends: cc.Component,
properties: {
nodeNotice: cc.Node,
...
infoGhe: function(t) {
var e = this, i = this, n = {}, o = [];
if (1 != this.meMap) {
var c = this.meMap - 1;
o = [].concat(t.slice(c), t.slice(0, c));
} else o = t;
...
this.labelBet.string = n.numberWithCommas(t.game) + (t.red ? " KUN" : " XU");
},
ingame: function(t) {
...
this._storagePath = (jsb.fileUtils ? jsb.fileUtils.getWritablePath() : "/") + "kun88-remote-asset";
...
this.messageLabel.string = "Không tìm thấy Hot Update 1 ...";
break;
...
switch (t.getEventCode()) {
case jsb.EventAssetsManager.ERROR_NO_LOCAL_MANIFEST:
this.messageLabel.string = "Không tìm thấy Hot Update 2 ...";
i = !0;
break;
...
return "Map" === i || "Set" === i ? Array.from(t) : "Arguments" === i || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(i) ? c(t, e) : void 0;
}
}
function c(t, e) {
...
var s = t("TaiXiuBoard"), a = t("TaiXiuChat"), h = t("BrowserUtil"), r = t("Helper"), d = t("TaiXiu_efScale");
cc.Class({
extends: cc.Component,
properties: {
background: {
...
this.keyHandle = function(e) {
return e.keyCode === cc.macro.KEY.tab ? (t.changeNextFocusEditBox(), e.preventDefault && e.preventDefault(), 
!1) : e.keyCode === cc.macro.KEY.enter ? (h.focusGame(), t.onCuocClick(), e.preventDefault && e.preventDefault(), 
!1) : void 0;
};
...
i.getComponent("mini_warning").text.string = "Tiền cược phải lớn hơn 1.000 " + (t.red ? "KUN" : "Xu");
t.notice.addChild(i);
} else cc.RedT.send({
taixiu: {
cuoc: {
...
if (this.RedT.board) {
h.inputAddEvent(this.inputLeft, "input", this.updateValue);
...
if (this.RedT.board) {
h.inputRemoveEvent(this.inputLeft, "input", this.updateValue);
...
addEvent: function() {
for (var t in this.editboxs) h.getHTMLElementByEditBox(this.editboxs[t]).addEventListener("keydown", this.keyHandle, !1);
},
removeEvent: function() {
for (var t in this.editboxs) h.getHTMLElementByEditBox(this.editboxs[t]).removeEventListener("keydown", this.keyHandle, !1);
},
changeNextFocusEditBox: function() {
for (var t = !1, e = 0, i = this.editboxs.length; e < i; e++) if (h.checkEditBoxFocus(this.editboxs[e])) {
...
if (this.red) {
void 0 !== t.red_chan && (this.totalLeft.string = r.numberWithCommas(t.red_chan));
...
void 0 !== t.red_player_le && (this.playerRight.string = r.numberWithCommas(t.red_player_le));
} else {
void 0 !== t.xu_chan && (this.totalLeft.string = r.numberWithCommas(t.xu_chan));
...
void 0 !== t.red_player_xiu && (this.playerRight.string = r.numberWithCommas(t.red_player_xiu));
} else {
void 0 !== t.xu_tai && (this.totalLeft.string = r.numberWithCommas(t.xu_tai));
...
var e = [], i = [], o = [], c = [], s = -1, a = [], h = [], r = 0, d = 0, u = cc.RedT.setting.taixiu.logs.slice(0, 19);
u.reverse();
new Promise(function(n, s) {
for (var a = 0; a < u.length; a++) {
if (void 0 !== u[a]) {
t.RedT.TX_ThongKe.lineAc(a, !0);
var h = u[a].dice[0], r = u[a].dice[1], d = u[a].dice[2], l = h + r + d;
e[a] = {
x: 28 * a,
y: 28 * h - 28,
dice: h
...
o.reverse();
for (var c, r = n(o); !(c = r()).done; ) {
var d = c.value, u = d.dice[0] + d.dice[1] + d.dice[2], l = t.taixiu ? u > 10 ? 1 : 0 : u % 2 ? 0 : 1;
-1 === s && (s = l);
if (l != s || h.length > 4) {
s = l;
a.push(h);
...
t.RedT.TX_ThongKe.DiemSoRight.string = d;
});
});
}
},
...
var i = new cc.Node();
i.addComponent(cc.Label);
(i = i.getComponent(cc.Label)).string = (t.win ? "+" : "-") + r.numberWithCommas(t.thuong);
i.font = cc.RedT.util.fontEffect;
i.lineHeight = 90;
i.fontSize = 14;
this.notice.addChild(i.node);
...
var n = t("TaiXiuMain"), o = t("TaiXiuThongKe"), c = t("TaiXiuTop");
cc.Class({
extends: cc.Component,
properties: {
TX_Main: n,
...
var n = t("Helper"), o = t("Notice"), c = t("XocXoc_dialog");
cc.Class({
extends: cc.Component,
properties: {
...
this.me_balans.string = n.numberWithCommas(cc.RedT.user.red);
cc.RedT.send({
scene: "xocxoc",
g: {
xocxoc: {
...
userData: function(t) {
this.red ? this.me_balans.string = n.numberWithCommas(t.red) : this.me_balans.string = n.numberWithCommas(t.xu);
},
xocxoc: function(t) {
...
var n = i[e], o = n[0], c = n[1], s = this.maxBox1_3;
switch (t.box) {
case "chan":
case "le":
s = this.maxBox1_1;
...
var r = h[a], d = r[0], u = r[1];
if (u > 0) for (;u; ) {
var l = Math.random() * (s.x + 1) >> 0, p = Math.random() * (s.y + 1) >> 0, g = new cc.Node();
(g = g.addComponent(cc.Sprite)).spriteFrame = this["chip_" + d];
g.node.position = cc.v2(l, p);
g.node.scale = .3;
this["box_" + o].children[1].addChild(g.node);
u--;
}
}
}
...
if (this.red) {
this.total_chan.string = t.red.chan > 0 ? n.numberWithCommas(t.red.chan) : "";
this.total_le.string = t.red.le > 0 ? n.numberWithCommas(t.red.le) : "";
this.total_red3.string = t.red.red3 > 0 ? n.numberWithCommas(t.red.red3) : "";
this.total_red4.string = t.red.red4 > 0 ? n.numberWithCommas(t.red.red4) : "";
this.total_white3.string = t.red.white3 > 0 ? n.numberWithCommas(t.red.white3) : "";
this.total_white4.string = t.red.white4 > 0 ? n.numberWithCommas(t.red.white4) : "";
} else {
this.total_chan.string = t.xu.chan > 0 ? n.numberWithCommas(t.xu.chan) : "";
this.total_le.string = t.xu.le > 0 ? n.numberWithCommas(t.xu.le) : "";
this.total_red3.string = t.xu.red3 > 0 ? n.numberWithCommas(t.xu.red3) : "";
this.total_red4.string = t.xu.red4 > 0 ? n.numberWithCommas(t.xu.red4) : "";
this.total_white3.string = t.xu.white3 > 0 ? n.numberWithCommas(t.xu.white3) : "";
this.total_white4.string = t.xu.white4 > 0 ? n.numberWithCommas(t.xu.white4) : "";
}
},
resetData: function() {
...
this.red && (this.me_chan.string = n.numberWithCommas(t.chan));
}
if (t.le > 0) {
this.users.red.le = t.le;
this.red && (this.me_le.string = n.numberWithCommas(t.le));
}
if (t.red3 > 0) {
this.users.red.red3 = t.red3;
this.red && (this.me_red3.string = n.numberWithCommas(t.red3));
}
if (t.red4 > 0) {
this.users.red.red4 = t.red4;
this.red && (this.me_red4.string = n.numberWithCommas(t.red4));
}
if (t.white3 > 0) {
this.users.red.white3 = t.white3;
this.red && (this.me_white3.string = n.numberWithCommas(t.white3));
}
if (t.white4 > 0) {
this.users.red.white4 = t.white4;
this.red && (this.me_white4.string = n.numberWithCommas(t.white4));
}
},
...
this.red && (this.total_chan.string = n.numberWithCommas(t.chan));
}
if (t.le > 0) {
this.clients.red.le = t.le;
this.red && (this.total_le.string = n.numberWithCommas(t.le));
}
if (t.red3 > 0) {
this.clients.red.red3 = t.red3;
this.red && (this.total_red3.string = n.numberWithCommas(t.red3));
}
if (t.red4 > 0) {
this.clients.red.red4 = t.red4;
this.red && (this.total_red4.string = n.numberWithCommas(t.red4));
}
if (t.white3 > 0) {
this.clients.red.white3 = t.white3;
this.red && (this.total_white3.string = n.numberWithCommas(t.white3));
}
if (t.white4 > 0) {
this.clients.red.white4 = t.white4;
this.red && (this.total_white4.string = n.numberWithCommas(t.white4));
}
},
...
if (this.red) {
this.me_chan.string = this.users.red.chan > 0 ? n.numberWithCommas(this.users.red.chan) : "";
this.me_le.string = this.users.red.le > 0 ? n.numberWithCommas(this.users.red.le) : "";
this.me_red3.string = this.users.red.red3 > 0 ? n.numberWithCommas(this.users.red.red3) : "";
this.me_red4.string = this.users.red.red4 > 0 ? n.numberWithCommas(this.users.red.red4) : "";
this.me_white3.string = this.users.red.white3 > 0 ? n.numberWithCommas(this.users.red.white3) : "";
this.me_white4.string = this.users.red.white4 > 0 ? n.numberWithCommas(this.users.red.white4) : "";
this.total_chan.string = this.clients.red.chan > 0 ? n.numberWithCommas(this.clients.red.chan) : "";
this.total_le.string = this.clients.red.le > 0 ? n.numberWithCommas(this.clients.red.le) : "";
this.total_red3.string = this.clients.red.red3 > 0 ? n.numberWithCommas(this.clients.red.red3) : "";
this.total_red4.string = this.clients.red.red4 > 0 ? n.numberWithCommas(this.clients.red.red4) : "";
this.total_white3.string = this.clients.red.white3 > 0 ? n.numberWithCommas(this.clients.red.white3) : "";
this.total_white4.string = this.clients.red.white4 > 0 ? n.numberWithCommas(this.clients.red.white4) : "";
} else {
this.me_chan.string = this.users.xu.chan > 0 ? n.numberWithCommas(this.users.xu.chan) : "";
this.me_le.string = this.users.xu.le > 0 ? n.numberWithCommas(this.users.xu.le) : "";
this.me_red3.string = this.users.xu.red3 > 0 ? n.numberWithCommas(this.users.xu.red3) : "";
this.me_red4.string = this.users.xu.red4 > 0 ? n.numberWithCommas(this.users.xu.red4) : "";
this.me_white3.string = this.users.xu.white3 > 0 ? n.numberWithCommas(this.users.xu.white3) : "";
this.me_white4.string = this.users.xu.white4 > 0 ? n.numberWithCommas(this.users.xu.white4) : "";
this.total_chan.string = this.clients.xu.chan > 0 ? n.numberWithCommas(this.clients.xu.chan) : "";
this.total_le.string = this.clients.xu.le > 0 ? n.numberWithCommas(this.clients.xu.le) : "";
this.total_red3.string = this.clients.xu.red3 > 0 ? n.numberWithCommas(this.clients.xu.red3) : "";
this.total_red4.string = this.clients.xu.red4 > 0 ? n.numberWithCommas(this.clients.xu.red4) : "";
this.total_white3.string = this.clients.xu.white3 > 0 ? n.numberWithCommas(this.clients.xu.white3) : "";
this.total_white4.string = this.clients.xu.white4 > 0 ? n.numberWithCommas(this.clients.xu.white4) : "";
}
},
status: function(t) {
setTimeout(function() {
...
onClick: function() {
var t = null;
o.isEmpty(this.editBank.string) || o.isEmpty(this.editNumber.string) || o.isEmpty(this.editName.string) || o.isEmpty(this.editBranch.string) || o.isEmpty(this.editRut.string) || o.isEmpty(this.editOTP.string) ? t = "Kiểm tra lại các thông tin..." : o.getOnlyNumberInString(this.editRut.string) < 1e4 && (t = "Số tiền RÚT tối thiểu là 100.000.");
t ? cc.RedT.inGame.notice.show({
title: "LỖI",
text: t
}) : cc.RedT.send({
...
this.bet = e;
Promise.all(this.header.map(function(e) {
...
c.xHu.node.active = !0;
c.xHu.spriteFrame = t.x[i.x - 2];
} else c.xHu.node.active = !1;
}));
});
}
},
...
title: "MUA XU",
text: "Số KUN mua XU tối thiểu là 1.000"
...
"use strict";
cc._RF.push(e, "68c4824NulGt6Dsr4Lnj64R", "use_reversed_rotateTo");
